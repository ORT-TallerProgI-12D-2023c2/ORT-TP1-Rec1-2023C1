...
public class TestCentro {
	...
	public static void main(String[] args) {
		...
		/*
		 * NO DEBEN MODIFICAR NADA DE ESTA CLASE! Si completan la lógica del ejercicio
		 * correctamente, debería funcionar
		 */

		/*
		 * Lean atentamente cada creación de objeto, cada captura de excepción y cada
		 * detalle para poder completar el resto de las clases con sus correspondientes
		 * constructores y estructuras.
		 */
	...
	private static List<Evaluacion> obtenerEvaluaciones() {
		...
		EvaluacionPorPedidoMedico pm4 = new EvaluacionPorPedidoMedico(7, "10/05/2023", "MURIEL Z.", Puntaje.PROMEDIO_ALTO, "LIC. BEATRIZ L.");
		...
		EvaluacionPorContinuidad pc3 = new EvaluacionPorContinuidad(6, "17/05/2023", "VALERIA C.", Puntaje.MUY_ALTO, "PROFUNDIZAR LECTURA Y ORALIDAD");
	...
	private static List<Diagnostico> generarDatosCentro() {
		...
		testAgregarEvaluacionADiagnostico(diagnosticos.get(3), evaluaciones.get(6), Jornada.MIERCOLES, Guardia.TARDE);
